...
const steps = [
  {
    ...
    body: `"Send me your September bank statements, invoices, and payroll report by the 15th." Finly turns it into a checklist and a link — nothing for the client to install or log into.`,
  },
  {
    num: "02",
  ...
  {
    num: "03",
    title: "Finly checks it against the request",
  ...
  return (
    <section id="how-it-works" className="border-t border-rule">
      <div className="mx-auto max-w-6xl px-6 py-24 lg:px-8 lg:py-32">
        <BlurFade>
          <p className="font-mono text-[13px] text-accent">How it works</p>
            ...
            {steps.map((step, i) => (
              <BlurFade key={step.num} delay={i * 0.06} offset={10}>
                <div className="grid grid-cols-[48px_1fr] gap-5">
                  <span className="pt-0.5 font-mono text-[13px] text-accent">{step.num}</span>
                  <div>
